...
#   represents True. An internal node in a binary tree has either the value 
#   2 or 3, where 2 represents True. Non-leaf nodes have either the value 2 or 3, 
...
#       operation of its value with the children's evaluations. Return the 
...
# recursive cases
#     else return helper left operator helper right
...
ex_1 = TreeNode(2, TreeNode(1, None, None), TreeNode(3, None, None))
ex_2 = TreeNode(0)

print(evaluateTree(ex_1) == True)
print(evaluateTree(ex_2) == False)